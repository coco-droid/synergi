...
pinecone_api_key = "8d5389f5-d30a-424b-a780-393ca5bcccfb"
openai_api_key = "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"

# Create an instance of the Agent class
agent = Agent(pinecone_api_key, openai_api_key)

# Simulate user interaction
#agent.store_message("i like to eat apples")
#agent.store_message("i remenber this day when i was a child i was full of joy") 
#agent.store_message("i  am a good person")
#agent.store_message("love all person")
#agent.store_message("eat banana is good")
#test search
results = agent.search_memory("love eat")
